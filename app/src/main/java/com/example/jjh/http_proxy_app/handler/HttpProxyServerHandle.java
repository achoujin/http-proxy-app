package com.example.jjh.http_proxy_app.handler;

import com.example.jjh.http_proxy_app.exception.HttpProxyExceptionHandle;
import com.example.jjh.http_proxy_app.intercept.HttpProxyIntercept;
...
import com.example.jjh.http_proxy_app.proxy.ProxyConfig;
import com.example.jjh.http_proxy_app.proxy.ProxyHandleFactory;
...
import com.example.jjh.http_proxy_app.util.ProtoUtil;
    ...
    HttpProxyInterceptPipeline interceptPipeline = new HttpProxyInterceptPipeline(
        new HttpProxyIntercept() {
          ...
          public void afterResponse(Channel clientChannel, Channel proxyChannel,
            ...
            System.out.println("after--HttpResponse" + httpResponse);
          ...
          public void afterResponse(Channel clientChannel, Channel proxyChannel,
            ...
            System.out.println("after--httpContent" + httpContent);
